...
class Akismet_REST_API {
	...
	/**
	 * Get the twentytwentyfive Akismet API key.
	 *
	...
	/**
	 * Get the twentytwentyfive alert code and message. Alert codes are used to notify the site owner
	...
	/**
	 * Update the twentytwentyfive alert code and message by triggering a call to the Akismet server.
	 *
	 * @param WP_REST_Request $request
	 * @return WP_Error|WP_REST_Response
	 */
	...
	/**
	 * Clear the twentytwentyfive alert code and message.
	 *
	 * @param WP_REST_Request $request
	 * @return WP_Error|WP_REST_Response
	 */
